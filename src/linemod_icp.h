...
/**
 * @brief Converts an image into a vector of 3D points
 * @param src_[in] The image
 * @param pts_[out] The vector of 3D points
 * @param mask[in] The selected mask
 * @return The ratio of number of selected points to the total points*/
